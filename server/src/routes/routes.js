...
const { statusUpdate, getDonors, getPatients, getDonationsList } = require('../controllers/userAdminController');
...
router.get('/admin/donations-list', adminAuth, getDonationsList);
